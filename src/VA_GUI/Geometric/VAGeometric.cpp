...
const uint16_t Point::getX(void) const
{
  return this->_x;
}

const uint16_t Point::getY(void) const
{
  return this->_y;
}

void Point::setX(const uint16_t value)
{
  this->_x = value;
}

void Point::setY(const uint16_t value)
{
  this->_y = value;
}
...
Rectangle::Rectangle(const Point & nullPoint, const uint16_t width, const uint16_t height, const Colors color)
...
Rectangle::Rectangle(Rectangle && other)
  : _nullPoint(std::move(other._nullPoint)), _width(std::move(other._width)), _height(std::move(other._height)),
...
Rectangle::Rectangle(const Rectangle & other)
  : Rectangle(other.getNullPoint(), other.getWidth(), other.getHeight(), other.getColor())
{
  /* There's nothing here */
}
...
const Point Rectangle::getNullPoint(void) const
{
  return this->_nullPoint;
}

const uint16_t Rectangle::getWidth(void) const
{
  return this->_width;
}

const uint16_t Rectangle::getHeight(void) const
{
  return this->_height;
}
...
const Colors Rectangle::getColor(void) const
{
  return this->_color;
}

void Rectangle::setNullPoint(const Point & value)
{
  this->_nullPoint = value;
}

void Rectangle::setWidth(const uint16_t value)
{
  this->_width = value;
}

void Rectangle::setHeight(const uint16_t value)
{
  this->_height = value;
}

void Rectangle::setColor(const Colors value)
{
  this->_color = value;
}
...
const Point Ellipse::calcNullPoint(const Point & center, const uint16_t width, const uint16_t height)
{
...
Ellipse::Ellipse(const Point & center, const uint16_t width, const uint16_t height, const Colors color)
...
Curve::Curve(const Point & center, const uint16_t width, const uint16_t height, Mode mode, const Colors color)
  : Ellipse(center, width, height, color), _mode(Mode::MODE0)
{
  this->setMode(mode);
}

Curve::Curve(const Curve & other) : Ellipse(other), _mode(other._mode)
{
  /* There's nothing here */
}

Curve::Curve(Curve && other) : Ellipse(std::move(other)), _mode(other._mode)
{
  /* There's nothing here */
}

Curve::Curve(const Rectangle & other, Mode mode) : Ellipse(other), _mode(Mode::MODE0)
{
  this->setMode(mode);
}

Curve::Curve(Rectangle && other, Mode mode) : Ellipse(std::move(other)), _mode(Mode::MODE0)
{
  this->setMode(mode);
}
...
const Curve::Mode Curve::getMode(void) const
{
  return this->_mode;
}
...
RoundRect::RoundRect(
  const Point & nullPoint, const uint16_t width, const uint16_t height, uint16_t radius, const Colors color)
...
RoundRect::RoundRect(const Rectangle & other, uint16_t radius) : Rectangle(other), _radius(0)
{
  this->setRadius(radius);
}

RoundRect::RoundRect(Rectangle && other, uint16_t radius) : Rectangle(std::move(other)), _radius(0)
{
  this->setRadius(radius);
}
...
const uint16_t Triangle::calcWorH(
  const Point & nullPoint, const std::vector<Point> & points, const uint16_t (Point::*const get)(void) const) const
{
  uint16_t max = 0;
...
Triangle::Triangle(const std::vector<Point> & points, const Colors color) : Rectangle(), _points(3, Point())
{
...
Triangle::Triangle(const Point & point1, const Point & point2, const Point & point3, const Colors color)
  : Triangle({ point1, point2, point3 }, color)
{
  /* There's nothing here */
}

Triangle::Triangle(const Point points[3], const Colors color) : Triangle(points[0], points[1], points[2], color)
{
  /* There's nothing here */
}

Triangle::Triangle(const Triangle & other) : Rectangle(other), _points(other._points)
{
  /* There's nothing here */
}
